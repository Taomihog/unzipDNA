...
namespace {
    ...
    */
    ...
    // constexpr int terms = 15; //Taylor
    // constexpr auto Factorial = [] {
    //     std::array<int, terms+1> arr = {};
    //     arr[0] = 1;
    //     int res = 1;
    ...
    //         result += Power(x, n) / Factorial.at(n);
    //     }
    //     return result;
    // }   
...
constexpr double force_min = 0.1;
constexpr double force_max = 50.0;
constexpr double force_interval = 0.1;
